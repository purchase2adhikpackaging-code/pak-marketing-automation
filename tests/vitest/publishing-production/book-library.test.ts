...
function compilerResult(status: "QA_PASSED" | "QA_FAILED"): CompileBookResult {
  ...
  return {
    ...
    blueprint: {
      ...
      level: job.level,
      purpose: "Teach governed railway engineering calculations.",
      ...
      chapters: [{
        ...
        number: 1,
        title: "Units",
        purpose: "Apply engineering units in railway calculations.",
        learningOutcomes: ["Apply units"],
        requiredKnowledgePackIds: ["railway-systems"],
        requiredVisualIds: [],
        workedExampleRequirements: ["One applied unit conversion example"],
        practicalRequirements: [],
        assessmentRequirements: ["One unit-conversion assessment"],
    ...
    render: {
      ...
      pageImagePaths: ["/tmp/page-001.png"],
    },
    resumedChapterIds: [],
    generatedChapterIds: [],
    incomplete: false,
