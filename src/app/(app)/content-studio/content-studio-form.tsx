    ...
    <div className="mt-8 grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
      ...
      <section className="min-h-[28rem] rounded-2xl border border-slate-800 bg-slate-950/60 p-6 shadow-sm" aria-live="polite">
        <div className="flex items-center justify-between gap-4">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500">Generated output</p>
            <h3 className="mt-2 text-lg font-semibold text-white">Script draft</h3>
          </div>
        ...
        {result.error ? (
          ...
          <div className="mt-6 rounded-xl border border-dashed border-slate-800 p-6 text-sm leading-6 text-slate-500">
            Enter an approved topic and grounding context, then generate a draft. The server will re-check your organization access before any AI request is made.
          </div>
        )}
      </section>
    </div>
